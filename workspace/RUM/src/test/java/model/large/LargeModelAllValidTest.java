...
/**
 * Does the same as LargeModelTest, but with every RPM valid (each value set to 1.0)
 */
public class LargeModelAllValidTest extends TestTest{
	
	private static String validValue = "1.0";
...
//		connect(c1, c2, r1, "5", null);
		...
		rpm_m1_3.getResourceFunctions().put(r31, new ResourceFunction("2.9"));
