...
public class SmallerLargeModel extends TestTest{
	...
	public void prepare() {
		...
		rpm1.add("rpm_m1_3", new ResourceFunction(1.7), new ResourceFunction(3.3), new ResourceFunction(1.9), new ResourceFunction(x->x[0]+x[1]+x[2], "r1", "r2", "r31"));
		...
		rpm1.add("rpm_m1_5", new ResourceFunction(0.4), new ResourceFunction(2.5), new ResourceFunction(7.5), new ResourceFunction(x->x[0]+x[1]+x[2], "r1", "r2", "r31"));

		RpmBuilder rpm2 = b.rpmBuilder(m2, r32, mr1, mr2);
		rpm2.add("rpm_m2_1", new ResourceFunction(3.8), new ResourceFunction("mr1"), new ResourceFunction(x->x[0]+x[1], "mr1", "r32"));
		rpm2.add("rpm_m2_2", new ResourceFunction(4.3), new ResourceFunction("mr1"), new ResourceFunction(x->x[0]+x[1], "mr1", "r32"));
		rpm2.add("rpm_m2_3", new ResourceFunction(4.6), new ResourceFunction("mr1"), new ResourceFunction(x->x[0]+x[1], "mr1", "r32"));
		rpm2.add("rpm_m2_4", new ResourceFunction(6.3), new ResourceFunction("mr1"), new ResourceFunction(x->x[0]+x[1], "mr1", "r32"));
