...
//		connect(c1, c2, r1, "5", null);
		...
		rpm_m1_5.getResourceFunctions().put(r31, new ResourceFunction("7.5"));
		rpm_m1_5.getResourceFunctions().put(mr1, new ResourceFunction("r1+r2+r31"));

		// rm2
		RPM rpm_m2_1 = new RPM("rpm_m2_1");
		rpm_m2_1.getResourceFunctions().put(r32, new ResourceFunction("3.8"));
		...
		rpm_m2_3.getResourceFunctions().put(r32, new ResourceFunction("4.6"));
		...
		rpm_m2_4.getResourceFunctions().put(r32, new ResourceFunction("6.3"));
